		...
		<div class="regist-center">
			...
			<div class="box">
				<h1>
					...
					<span v-if="false" @click="changeTypeHandle(1)" :class="{active: type===1}">{{$t('register.email')+$t('register.regist')}}</span> <!-- 邮箱注册 -->
				</h1>
				<ul>
					<li>
...
import { emailRegister, passwordLogoNew } from './request.js'
export default {
	components: {
		Headers
	},
