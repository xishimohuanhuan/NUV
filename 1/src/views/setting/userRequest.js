...
export const getEmailCode = (data) => {
    return vue.$axios({
        url: '/user/login/sendEmail',
        // baseURL: 'http://172.16.1.224:8007',
        method: 'post',
        data,
    })
}
...
export const sendMobileCode = (data) => {
    return vue.$axios({
        url: '/user/login/sendMsg',
        method: 'post',
        data,
    })
}
// 发送更改验证码
export const sendPwdMsgCode = (params) => {
    return vue.$axios({
        url: '/user/login/setPwdMsg',
        method: 'get',
        params,
    })
}
...
// 绑定手机号
export const postBindMobile = (data) => {
    return vue.$axios({
        url: '/user/bindMobile',
        method: 'post',
        data,
...
export const updatePayPassword = (data) => {
    return vue.$axios({
        // baseURL: 'http://172.16.1.224:8007',
        url: '/user/login/updPayPwd',
        method: 'post',
        data,
    })
}
// 绑定实名信息
export const postRealAuth = (data) => {
    return vue.$axios({
        // baseURL: 'http://172.16.1.224:8007',
        url: '/user/realAuth',
        method: 'post',
...
export const getInvitation = (data) => {
    return vue.$axios({
        url: `/user/generalize/ewm?userId=${data}`,
        method: 'get',
    })
}
// 获取上传图片token
...
// 获取实名认证信息查询
export const uploadImg = (data, fn) => {
    return vue.$axios({
        // baseURL: 'http://172.16.1.224:8007',
        url: '/user/uploadImg',
        method: 'post',
        onUploadProgress:function(progressEvent){ //原生获取上传进度的事件
            if(progressEvent.lengthComputable){
                ...
                let percent = Math.floor(progressEvent.loaded / progressEvent.total * 99);
                fn && fn(percent);
            }
        },
        data,
...
// 获取帮助中心列表
export const getHelpData = (data) => {
    return vue.$axios({
        url: '/user/help/getHelpType',
        method: 'get',
        params:data
    })
}
// 获取帮助中心列表下面的
export const getHelpDataDta = (data) => {
    return vue.$axios({
        url: '/user/help/getHelpCenter',
        method: 'get',
        params:data
    })
}
// 获取帮助中心列表下面的具体文章内容
export const getHelpArticle = (data) => {
    return vue.$axios({
        url: '/user/help/getHelpContent',
        method: 'get',
        params:data
    })
}
// 获取邀请数据
export const getinvitBlank = (data) => {
    return vue.$axios({
        url: '/user/invit/getExtUser',
        method: 'get',
        params:data
    })
}
// 获取邀请的人的详细信息
export const getinvitmessage = (data) => {
    return vue.$axios({
        url: '/user/invit/getInvitUsers',
        method: 'post',
        params:data
    })
}
// 获取邀请的人的二级
export const getinvitchildt = (data) => {
    return vue.$axios({
        url: '/user/invit/getChilds2',
        method: 'post',
        params:data
    })
}
// 佣金划转
export const invitTransferGoTo = (data) => {
    return vue.$axios({
        url: '/user/invit/transfer',
        method: 'get',
        params:data
    })
}
// 划转记录
export const invitTransRecords = (data) => {
    return vue.$axios({
        url: '/user/invit/transferRecords',
        method: 'post',
        params:data
    })
}
// 返佣资金
export const invitCommissionData = (data) => {
    return vue.$axios({
        url: '/user/invit/getCommDetails',
        method: 'post',
        params:data
    })
}
...
export const realAuthNotify = (data) => {
    return vue.$axios({
        data,
        url: '/user/realAuth/save',
        method: 'post',
    })
}

// 活体认证
export const userLifeCheck = (data) => {
    return vue.$axios({
        data,
        url: '/user/life/check',
        method: 'post',
...
// 运营商三要素
export const mobile_threeCheck = (data) => {
    return vue.$axios({
        data,
        url: '/user/mobile_three/check',
        method: 'post',
        withCredentials: false
    })
}
// 人脸对比
export const idCardAuthCheck = (data) => {
    return vue.$axios({
        data,
        url: '/user/idCardAuth/check',
        method: 'post',
        withCredentials: false,
        cache: false,
        processData: false,
