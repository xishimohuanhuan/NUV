...
const realNameCheck = () => import('./views/setting/realNameCheck.vue');  // 自动化实名认证
const lifeCheck = () => import('./views/setting/lifeCheck.vue');  // 活体检测
...
const checkCode = () => import('./views/setting/checkCode.vue');  //帮助中心，联系我们
